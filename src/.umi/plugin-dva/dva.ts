...
import dva from 'dva';
// @ts-ignore
import createLoading from '/Volumes/WorkSpace/Buck-blog-admin/node_modules/dva-loading/dist/index.esm.js';
...
app.model({ namespace: 'model', ...(require('/Volumes/WorkSpace/Buck-blog-admin/src/pages/ListBasicListThree/model.ts').default) });
