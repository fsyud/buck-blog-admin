...
interface OperationModalProps {
  ...
  visible: boolean;
  current: Partial<ProjectList> | undefined;
  onDone: () => void;
  onSubmit: (values: ProjectList, operate: string) => void;
  onCancel: () => void;
}
...
const OperationModal: FC<OperationModalProps> = (props) => {
  ...
  const handleFinish = (values: { [key: string]: any }) => {
    ...
    if (onSubmit) {
      onSubmit(values as ProjectList, operationState);
    }
  };
      ...
      <Form {...formLayout} form={form} onFinish={handleFinish}>
        ...
        <Form.Item
          ...
          rules={[
            ...
            { pattern: /(http|https):\/\/([\w.]+\/?)\S*/, message: '请输入正确的项目链接'}
          ]}
        >
          <Input placeholder="请输入" />
        </Form.Item>
